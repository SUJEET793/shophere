...
//    data part of the main Activity
    public static ArrayList<Main_list_item> assign_main_item() {

        ArrayList<Main_list_item> main_list_items= new ArrayList<>();
    ...
    public static ArrayList<Catagories_items> assign_cat_item() {
        ArrayList<Catagories_items> cat_items=new ArrayList<>();
        cat_items.add(new Catagories_items(R.drawable.tomato,"Tomato"));
        cat_items.add(new Catagories_items(R.drawable.tomato,"Tomato"));
        cat_items.add(new Catagories_items(R.drawable.tomato,"Tomato"));
        cat_items.add(new Catagories_items(R.drawable.tomato,"Tomato"));
        cat_items.add(new Catagories_items(R.drawable.tomato,"Tomato"));
